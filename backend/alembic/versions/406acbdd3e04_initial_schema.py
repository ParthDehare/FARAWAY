...
Revision ID: 406acbdd3e04
Revises: 
Create Date: 2026-06-13 01:24:27.708844
...
def upgrade() -> None:
    ...
    op.create_table('maintenance_crews',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    sa.Column('health_index', sa.SmallInteger(), nullable=True),
    sa.Column('status', sa.String(), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['current_segment_id'], ['segments.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('health_index_at_creation', sa.SmallInteger(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['crew_id'], ['maintenance_crews.id'], ),
    sa.ForeignKeyConstraint(['segment_id'], ['segments.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
